...
namespace _2DPlatformer.States
{
    public class GameState : State
    {
        ...
        public static Texture2D grass2_texture, enemy_texture, dirt_texture, coin_texture, grass_texture, spike_texture, sign_texture;
        ...
        {
            map = new Map();
            player = new Player(_content.Load<Texture2D>("Sprites/character"), new Vector2(38, 157), platforms, enemies);
            camera = new Camera();
            ...
            enemy_texture = _content.Load<Texture2D>("Sprites/mushroom");
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(score_font, score_str, score_pos, Color.White);
            spriteBatch.End();
        }
    }
}
